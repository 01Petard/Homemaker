...
public class ShowInforActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showinfor);
    ...
    private void initView() {
        ...
        tv_sign.setText(MyApplication.userEntity.userData.getSign());
        tv_username.setText(MyApplication.userEntity.userData.getUsername());
        tv_sex.setText(MyApplication.userEntity.userData.getSex());
        tv_birth.setText(MyApplication.userEntity.userData.getBirthday());
    ...
    private void infor_dialog() {
        ...
        new AlertDialog.Builder(ShowInforActivity.this)
                .setTitle("修改个性签名")
                .setView(change_name)
