...
public class PiclocationActivity extends Activity implements LocationSource, AMapLocationListener, PoiSearch.OnPoiSearchListener, AMap.OnCameraChangeListener, GeocodeSearch.OnGeocodeSearchListener,AMap.OnMapClickListener,AMap.OnMarkerClickListener {
...
//                                .icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource(getResources(), R.mipmap.roundpoint))));
...
//        poiSearch.searchPOI();//不能在主线程实现耗时操作
    ...
    public void onCameraChange(CameraPosition cameraPosition) {
       ...
       // roundMarker.setPosition(cameraPosition.target);
