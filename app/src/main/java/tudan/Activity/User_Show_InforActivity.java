...
public class User_Show_InforActivity extends AppCompatActivity implements View.OnClickListener {
...
//                new ImgDownTask().execute(Config.BASEHOST + MyApplication.userEntity.userData.getAvatar());
                returnInfor=MyApplication.getUserInfor();
                user=returnInfor.getCourier();
                String avatar=Config.BASEHOST+user.getAvatar();
...
//                break;
    ...
    private void infor_dialog() {
        ...
        new AlertDialog.Builder(User_Show_InforActivity.this)
                .setTitle("修改个性签名")
                .setView(change_name)
