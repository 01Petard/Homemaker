...
import tudan.Activity.OrderActivity;
...
public class SelectAdapter extends RecyclerView.Adapter<SelectAdapter.ViewHolder> {
    ...
    public  SelectAdapter(OrderActivity activity, SparseArray<GoodsItem> dataList){
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private TextView tvCount,tvCost,tvAdd,tvMinus,tvName;
